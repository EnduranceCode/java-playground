 ...
 * 
 */
@WebServiceClient(name = "CidadeSOAPService", targetNamespace = "http://soap.web.digital.agenda.everis.com/", wsdlLocation = "http://localhost:8080/agenda-digital-web/soap/ClienteSOAP?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CIDADESOAPSERVICE_QNAME = new QName("http://soap.web.digital.agenda.everis.com/", "CidadeSOAPService");
    ...
    public CidadeSOAP getCidadeSOAPPort() {
        return super.getPort(new QName("http://soap.web.digital.agenda.everis.com/", "CidadeSOAPPort"), CidadeSOAP.class);
    }
    ...
    public CidadeSOAP getCidadeSOAPPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.web.digital.agenda.everis.com/", "CidadeSOAPPort"), CidadeSOAP.class, features);
    }
