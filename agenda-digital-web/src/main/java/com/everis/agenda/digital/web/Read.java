...
public class Read extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (Cidade cidadeActual : Storage.getCidades()) {
			out.println("<tr><td>" + cidadeActual.getCodigo() + "</td><td>"+ cidadeActual.getNome() + "</td><td><a style=\"margin-right: 10px;\" class=\"btn btn-small btn-success\">Editar</a><a class=\"btn btn-small btn-danger\">Eliminar</a></td></tr>");
		}
