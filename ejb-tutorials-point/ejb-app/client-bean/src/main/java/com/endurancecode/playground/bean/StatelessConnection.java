...
import com.endurancecode.playground.bean.stateless.LibraryStatelessSessionBeanRemote;
...
public final class StatelessConnection {
    ...
    private static final String JNDI_NAME_STATELESS_BEAN = "ejb:/ejb-library/LibraryStatelessSessionBean!com.endurancecode.playground.bean.stateless.LibraryStatelessSessionBeanRemote";
    ...
    public static void testStatelessEjbConnection(InitialContext context, BufferedReader reader) {
        try {
            ...
            LibraryStatelessSessionBeanRemote libraryBeanFirstLookup = (LibraryStatelessSessionBeanRemote) context.lookup(
            ...
            LibraryStatelessSessionBeanRemote libraryBeanSecondLookup = (LibraryStatelessSessionBeanRemote) context.lookup(
                    JNDI_NAME_STATELESS_BEAN);
